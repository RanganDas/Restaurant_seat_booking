<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql_query = mysqli_query($conn, "SELECT * FROM users WHERE email='$email' AND password='$password'") OR die("query failed");
...
<body>
    <div class="form-container">
        <form action="" method="post">
            ...
            <p>Do not have an account? <a href="user_signup.php">Signup now</a></p>
