<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $sql_query = mysqli_query($conn, "SELECT * FROM `admin` WHERE email='$email' ") OR die("query failed");
            ...
            else
            {
                ...
                try 
                {
                    ...
                    $sql = "INSERT INTO admin(name, email, password, verification_code, email_verified_at) VALUES ('" . $name . "', '" . $email . "', '" . $password . "',  '" . $verification_code . "', NULL)";
                    mysqli_query($conn, $sql);
                    
                    header("Location: main_admin_emailverfy.php?email=" . $email);
                    exit();
                } 
                catch (Exception $e) 
                {
...
<body>
    <div class="form-container">
        <form action="" method="post">
            ...
            <p>Already have an account? <a href="main_admin_login.php">Login now</a></p>
        </form>
    </div>
</body>
</html>